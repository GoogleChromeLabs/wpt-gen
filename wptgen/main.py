...
def config_callback(
    ...
    """
    Manage WPT-Gen configuration. Displays active configuration if no subcommand is provided.  # pylint: disable=line-too-long
    """
...
def audit(
    ...
    """
    Perform a gap analysis and generate coverage blueprints without generating WPT files.  # pylint: disable=line-too-long
    """
    _print_workflow_banner(web_feature_id)
    _check_workflow_flags(
        wf_yml_update=wf_yml_update,
