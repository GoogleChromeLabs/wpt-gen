...
def test_tool_read_file(wpt_root: Path,
                        agent_tools: dict[str, FunctionTool]) -> None:
...
def test_tool_write_file(wpt_root: Path,
                         agent_tools: dict[str, FunctionTool]) -> None:
...
def test_tool_search_files(wpt_root: Path,
                           agent_tools: dict[str, FunctionTool]) -> None:
...
def test_tool_delete_file(wpt_root: Path,
                          agent_tools: dict[str, FunctionTool]) -> None:
...
def test_tool_search_file_contents(
        wpt_root: Path, agent_tools: dict[str, FunctionTool]) -> None:
