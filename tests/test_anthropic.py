...
def test_get_llm_client_anthropic(mocker: MockerFixture,
                                  anthropic_config: Config) -> None:
...
def test_anthropic_generate_content(mocker: MockerFixture,
                                    anthropic_config: Config) -> None:
    ...
    client = AnthropicClient(api_key=anthropic_config.api_key,
    ...
    mock_anthropic_class.assert_called_once_with(api_key='mock-anthropic-key',
                                                 timeout=600.0)
...
def test_anthropic_generate_content_no_content(
        mocker: MockerFixture, anthropic_config: Config) -> None:  # pylint: disable=line-too-long
...
def test_anthropic_count_tokens(mocker: MockerFixture,
                                anthropic_config: Config) -> None:
...
def test_anthropic_retry_on_failure(mocker: MockerFixture,
                                    anthropic_config: Config) -> None:
...
def test_anthropic_prompt_exceeds_limit(mocker: MockerFixture,
                                        anthropic_config: Config) -> None:
